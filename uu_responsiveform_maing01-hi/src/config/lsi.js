const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uuResponsiveform",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuResponsiveform.",
      en: "You can buy your own uuResponsiveform.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuResponsiveform.",
      en: "You don't have rights to initialize this uuResponsiveform.",
    },
  },
