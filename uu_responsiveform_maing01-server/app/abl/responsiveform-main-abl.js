...
const Errors = require("../api/errors/responsiveform-main-error.js");
...
const logger = LoggerFactory.get("ResponsiveformMainAbl");

class ResponsiveformMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["responsiveformMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuResponsiveform",
        typeCode: "uu-responsiveform-maing01",
        location: location,
...
module.exports = new ResponsiveformMainAbl();
